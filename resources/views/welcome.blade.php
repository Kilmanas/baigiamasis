...
<div
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ url('/home') }}" class="btn btn-light">Vartotojo meniu</a>
            @else
                <a href="{{ route('login') }}" class="btn btn-light">Prisijungti</a>

                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="btn btn-light">Registruotis</a>
                @endif
            @endauth
        </div>
    @endif
