        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="form2" method="post" action="{{ route('company-create') }}">
                        @csrf
                        <div class="row mb-3">
                            <label for="company" class="col-md-4 col-form-label text-md-end">{{ __('Įmonės pavadinimas') }}</label>

                            <div class="col-md-6">
                                <input id="company" name="company" type="text" class="form-control">
                            </div>
                        </div><div class="row mb-3">
                            <label for="address" class="col-md-4 col-form-label text-md-end">{{ __('Įmonės adresas') }}</label>

                            <div class="col-md-6">
                                <input id="address" name="address" type="text" class="form-control">
                            </div>
                        </div><div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label text-md-end">{{ __('Įmonės telefonas') }}</label>
                    ...
                    <div class="row mb-0">
                        <div class="col-md-6 offset-md-4">
                            <input id="submit" type="button" class="btn btn-primary" value="Registruotis">
                        </div>
                    </div>
                </div>
            </div>
